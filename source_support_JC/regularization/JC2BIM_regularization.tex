...
\newcommand{\dotitlepage}{%
  \begin{frame}
    ...
    \end{center}
    \vfill
    \includegraphics[width=2cm]{logo_sfbi}\hfill
...
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=.8\textwidth]{figures/crit_lassounnamed-chunk-36-1} 

\includegraphics[width=.8\textwidth]{figures/crit_lassounnamed-chunk-36-2} 
