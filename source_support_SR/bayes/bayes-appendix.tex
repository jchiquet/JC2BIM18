...
%====================================================================
\frame{ \frametitle{Monte Carlo: Illustration (1/2)} \label{app:MCillustration}
...
%====================================================================
\frame{ \frametitle{Monte Carlo: Illustration (2/2)}
  ...
  \begin{tabular}{cc}
    ...
    \end{tabular}
  \end{tabular}
  \appref{back:MCillustration}
}

%====================================================================
\frame{ \frametitle{Posterior distribution and CI} \label{app:CIcontrast}

  Posterior sample for a combination of parameters, e.g.
  $$
  \delta =  \theta_2 - \theta_3
  $$
  \ra Simply take $\delta^b = \theta_2^b - \theta_3^b$, with $\thetabf^b$ sampled from $p(\thetabf \gv \Ybf)$.
  ...
  \hline 
  delta & 9.289765  & 9.171537  & 3.614869  & 15.38288 
  \end{tabular} } \end{center}
  
  \appref{back:CIcontrast}
}
